...
|---|---|---|
| [**tubertico.com**](https://tubertico.com) | Full company website — deployed and maintained in production | Java, Spring Boot, Thymeleaf, Docker, DigitalOcean |
| **Tubertico ERP** *(in progress)* | Internal ERP system with inventory, purchasing, and reporting modules | React 19, TypeScript, Express, PostgreSQL |
...
# Hola, soy Cristian Quirós 👋

**Estudiante de Ingeniería del Software & Desarrollador Full Stack**
<br/>
📍 San José, Costa Rica &nbsp;|&nbsp; 🎓 Universidad Latina de Costa Rica
<br/><br/>
...
|---|---|---|
| [**tubertico.com**](https://tubertico.com) | Sitio web completo de la empresa — desplegado y mantenido en producción | Java, Spring Boot, Thymeleaf, Docker, DigitalOcean |
| **Tubertico ERP** *(en progreso)* | Sistema ERP interno con módulos de inventario, compras y reportes | React 19, TypeScript, Express, PostgreSQL |
